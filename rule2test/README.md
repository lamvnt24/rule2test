...
Tiếng Việt: [tổng quan và lộ trình](docs/vi/TONG-QUAN-VA-ROADMAP.md), [hướng dẫn sử dụng](docs/vi/HUONG-DAN-SU-DUNG.md), [slide chung kết Track 2](docs/slides/final-round2.pdf) (`make pdf` để dựng lại từ nguồn).
