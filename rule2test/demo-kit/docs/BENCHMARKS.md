...
| Automated test suite | **294 passing** | Unit, integration and evaluation tests on the machine producing this summary (ran 294 tests in 50.629s). | Test count is not a quality metric; it does not measure insurance-domain correctness. | `tests/` |
